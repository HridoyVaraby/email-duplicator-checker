  ...
  return (
    <div className="report-container">
      <div className="report-header">
        ...
        <p className="report-subtitle">Column Analyzed: <strong>{report.columnAnalyzed}</strong></p>
      </div>
      ...
      <div className="report-summary">
        <div className="summary-card">
          <h3>Summary</h3>
          <p>
            Successfully processed <strong>{report.totalRows.toLocaleString()}</strong> rows and identified
            <strong> {report.duplicateCount.toLocaleString()}</strong> duplicate entries in the
            <strong> "{report.columnAnalyzed}"</strong> column.
          </p>
          <p>
            Your cleaned dataset now contains <strong>{report.cleanedRows.toLocaleString()}</strong> unique rows,
            representing a <strong>{report.duplicatePercentage}%</strong> reduction from the original file.
          </p>
        </div>
      </div>
